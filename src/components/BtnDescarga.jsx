...
export default function BtnDescarga() {
  return (
    <div className="flex flex-col md:flex-row gap-4 mt-4">
      <div className="text-left flex items-center gap-2 px-4 py-1 bg-black text-white rounded-3xl w-52 hover:opacity-80 transition-all delay-100 cursor-pointer">
